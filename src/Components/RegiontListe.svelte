...
{#if showModal}
  <Modal bind:showModal>
    ...
    <hr />
    <br />
    <ol class="definition-list">voulez-vous vraiment supprimer cet région ?</ol>
    <hr />
...
<center>
  <input
    id="input"
    name="text"
    placeholder="Rechercher un région"
    type="search"
        ...
        <td>
          <Motion let:motion whileHover={{ rotate: "5deg", scale: 1.1 }}>
            <button
              ...
              use:motion
              on:click={() => {
                modifier(user["id"], user["nom"], user["code"]);
              }}
              ><svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
  ...
  {#if modif}
    <center>
      <form class="form-control" action="">
        <p class="title">Modifier la région</p>
        <div class="input-field">
          ...
          />
          <label class="label" for="input">Nom de la région</label>
        </div>
        <div class="input-field">
          <input
            required=""
          ...
          />
          <label class="label" for="input">code associer</label>
        </div>
        <br />
...
<div id="ajout">
  ...
  {#if ajout}
    <center>
      <form class="form-control" action="">
        <p class="title">Ajout d'un région</p>
        <div class="input-field">
          <input
            required=""
            class="input"
        ...
        <div class="input-field">
          ...
          />
          <label class="label" for="input">code de la région</label>
        </div>
        <br />
